...
if __name__ == '__main__':
    ...
    for newspaper in get_newspapers()["newspapers"]:
        ...
        for id_feature in features:
            ...
            model_NO_RAG = "LLM_resumen_NO_RAG_T"+str(id_feature)
            model_RAG = "LLM_resumen_RAG_T"+str(id_feature)

            # Connect to or create the vector collection for the specific newspaper
            collection = chroma_client.get_or_create_collection(name="datos_real_news_" + str(newspaper), embedding_function=embedding_fn)
